...
export const SEARCH_NICHES: SearchNicheTarget[] = [
  ...
  {
    slug: "car-wash",
    label: "lavado de autos y detallado",
    textQuery: "lavado de autos car wash detallado",
    typeLabel: "car_wash",
    includedType: "car_wash",
  },
  {
    slug: "upholstery",
    label: "tapicerias y vestiduras",
    textQuery: "tapicerias muebles vestiduras",
    typeLabel: "upholstery",
    includedType: "contractor",
  },
  {
    slug: "bakeries",
  ...
  {
    slug: "pest-control",
    label: "fumigadoras y plagas",
    textQuery: "fumigadoras control de plagas",
    typeLabel: "pest_control",
    includedType: "contractor",
  },
  {
    slug: "locksmiths",
    label: "cerrajerias y cerrajeros",
    textQuery: "cerrajerias cerrajeros llaves",
    typeLabel: "locksmith",
    includedType: "contractor",
  },
];
