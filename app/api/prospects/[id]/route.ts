...
export async function PATCH(request: NextRequest, context: ProspectRouteContext) {
  ...
  try {
    ...
    const item = await updateProspect(id, {
      ...
      segmentIdeal: typeof payload.segmentIdeal === "string" ? payload.segmentIdeal : undefined,
      painPoint: typeof payload.painPoint === "string" ? payload.painPoint : undefined,
      evidence: payload.evidence && typeof payload.evidence === "object" ? payload.evidence as Record<string, unknown> : undefined,
      recommendedOffer: typeof payload.recommendedOffer === "string" ? payload.recommendedOffer : undefined,
      ...
      nextFollowupAt: typeof payload.nextFollowupAt === "string" || payload.nextFollowupAt === null ? payload.nextFollowupAt : undefined,
      ...
      meetingAt: typeof payload.meetingAt === "string" || payload.meetingAt === null ? payload.meetingAt : undefined,
      proposalAt: typeof payload.proposalAt === "string" || payload.proposalAt === null ? payload.proposalAt : undefined,
      closedAt: typeof payload.closedAt === "string" || payload.closedAt === null ? payload.closedAt : undefined,
      revenue: typeof payload.revenue === "number" || payload.revenue === null ? payload.revenue : undefined,
