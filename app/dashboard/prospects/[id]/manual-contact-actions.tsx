...
function buildWhatsAppUrl(phone: string, name: string) {
  ...
  const shortMessage = `Hola, soy Felipe, desarrollador web en AionSite. Estuve viendo ${name} y creo que hay una oportunidad para conseguir más clientes desde Google. ¿Te puedo mandar una propuesta?`;
